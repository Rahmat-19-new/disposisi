...
<input class="form-control" type="text" name="no_surat" p
laceholder="NO SURAT MASUK" required />
</div>
<div class="mb-3">
<label >PERIHAL SURAT <code>*</code></label>
<input class="form-control" type="text" name="perihal" pl
aceholder="PERIHAL SURAT" required />
</div>
<div class="mb-3">
...
<input class="form-control" type="text" name="surat_to" p
laceholder="TUJUAN SURAT" required />
</div>
<div class="mb-3">
